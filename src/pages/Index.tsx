            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                ...
                <strong className="text-foreground">
                  Les Conférenciers est en contact direct avec chaque intervenant
                </strong>
                . Cette relation privilégiée nous permet d'assurer un suivi rapide, une communication fluide et un
                projet mené avec professionnalisme du brief initial jusqu'au jour J.
              </p>
          ...
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold mb-2">
                Les conférenciers avec qui nous travaillons
              </h2>
              <p className="text-muted-foreground">Il y a forcément le conférencier idéal pour votre événement</p>
            </div>
