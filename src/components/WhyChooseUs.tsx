...
const REASONS = [
  ...
  },
  {
    ...
    description: "Chaque conférencier est sélectionné pour son expertise unique et son talent d'orateur éprouvé. Nous connaissons personnellement nos intervenants, leurs styles, leurs forces et leur capacité à s'adapter à votre public.",
    stat: "100%",
    statLabel: "vérifiés",
  },
  {
    ...
    description: "Nous analysons votre projet en détail pour vous proposer l'intervenant qui répondra précisément à vos objectifs. Notre connaissance approfondie de chaque conférencier nous permet de vous recommander le profil idéal, au-delà du simple CV.",
    stat: "24h",
  ...
  },
  {
    ...
    description: "Nous ne listons pas des profils : nous vous conseillons le bon intervenant, challengeons votre brief et nous engageons sur le résultat. Notre relation privilégiée avec les conférenciers garantit une prestation de qualité.",
    stat: "500+",
