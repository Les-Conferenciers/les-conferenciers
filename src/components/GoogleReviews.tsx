...
const FALLBACK_REVIEWS: Omit<GoogleReview, "id">[] = [
  {
    ...
    rating: 5,
    comment: "Excellente collaboration avec l'agence pour notre conférence avec une personnalité : Nelly est une vraie professionnelle, réactive et à l'écoute de nos besoins.",
  ...
  },
  {
    ...
    author_photo_url: null,
    rating: 5,
    comment: "Nous avons fait appel à l'agence Les Conférenciers pour notre événement de fin d'année et nous en sommes pleinement satisfaits. Un accompagnement professionnel du début à la fin.",
  ...
  },
  {
    ...
    author_photo_url: null,
    rating: 5,
    comment: "J'ai apprécié le professionnalisme et le suivi de Nelly tout au long de l'organisation de l'événement qui a été du reste un franc succès.",
  ...
  },
  {
    ...
    author_photo_url: null,
    rating: 5,
    comment: "Nous avons été ravis par la prestation de l'Agence Les Conférenciers. Efficacité, réactivité et professionnalisme sont au rendez-vous.",
  ...
  },
  {
    ...
    author_photo_url: null,
    rating: 5,
    comment: "Je recommande pour une expérience parfaite ! Une grande qualité d'écoute et un suivi irréprochable de A à Z.",
